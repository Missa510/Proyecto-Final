...
<main>
    <div class="main-puro">
        ...
        <p class="fs-5">
            <strong>Nota del desarrollador:</strong> Cuando termines de actualizar el usuario, la sesión se te acabará y debes volver a ingresar, pio perdo por eso -_- Para regresar a la página principal sin hacer ningún cambio al usuario, debes apretar la tecla <code>alt</code> seguido de la flecha izquiera <code>&leftarrow;</code>. A continuación, debes refrescar la página y listo 😊
        </p>
        <form action="?control=modificar&&funcion=actualizar" method="post" class="mt-4 mb-4">
            <input type="hidden" name="id" id="Id" value="<?= $id; ?>">
            <div class="row g-2 mb-3">
                <div class="form-floating col">
                    <input type="text" name="sus" class="form-control" id="Usuarios" value="<?= $sus; ?>" placeholder="Usuario" required>
                    <label for="Usuarios">Usuario</label>
                    <div class="form-text text-dark">Debe ser original y no debe olvidarse nunca</div>
                </div>
                <div class="form-floating col">
                    <div class="form-floating">
                        <input type="password" name="pass" class="form-control" id="Password" value="<?= $pass; ?>" placeholder="Password" required>
            ...
            <div class="row g-2 mb-4">
                <div class="form-floating col">
                    <input type="email" name="email" class="form-control" id="Email" value="<?= $mail; ?>" placeholder="Email" required>
